...
//        messageBubbleLayer.fillColor = aMessage.messageSender.isUserSelf ? FTDefaultIncomingColor.cgColor :
...
//        messageBubbleLayer.fillColor = aMessage.messageSender.isUserSelf ? FTDefaultOutgoingColor.cgColor : FTDefaultIncomingColor.cgColor
        messageBubbleLayer.fillColor = aMessage.messageSender.isUserSelf ? UIColor(hexString: app_header_bg).cgColor : UIColor(hexString: app_dark_bg).cgColor
        ...
        messageLabel.textColor = aMessage.messageSender.isUserSelf ? UIColor.white : UIColor.white
        ...
        attributeString.addAttributes([NSAttributedString.Key.font:FTDefaultFontSize, NSAttributedString.Key.paragraphStyle: FTChatMessagePublicMethods.getFTDefaultMessageParagraphStyle()], range: NSMakeRange(0, (messageLabel.text! as NSString).length))
