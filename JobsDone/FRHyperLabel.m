...
+ (void)initialize {
	if (self == [FRHyperLabel class]) {
		FRHyperLabelLinkColorDefault = [UIColor colorWithRed:29/255.0 green: 89/255.0 blue:156/255.0 alpha:1];
//        UIColor * colors = [[UIColor init] initWithNetHex:0x636364];
//        FRHyperLabelLinkColorDefault = colors;
		FRHyperLabelLinkColorHighlight = [UIColor colorWithRed:29/255.0 green: 89/255.0 blue:156/255.0 alpha:1];
	}
}
...
//									  NSUnderlineStyleAttributeName: @(NSUnderlineStyleSingle)};
        self.linkAttributeDefault = @{NSForegroundColorAttributeName: FRHyperLabelLinkColorDefault,NSFontAttributeName: [UIFont boldSystemFontOfSize:14]};
	}
	
	if (!self.linkAttributeHighlight) {
		self.linkAttributeHighlight = @{NSForegroundColorAttributeName: FRHyperLabelLinkColorHighlight,NSFontAttributeName: [UIFont boldSystemFontOfSize:14]};
	}
}
