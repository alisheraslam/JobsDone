...
//MARK: - TimeLabel -
let FTDefaultTimeLabelHeight : CGFloat = 30.0
...
let FTDefaultInputTextViewEdgeInset: UIEdgeInsets = UIEdgeInsets(top: 5, left: 5, bottom: 5, right: 5)
...
//MARK: - MessageCell -
let FTDefaultMessageCellTimeLabelHeight : CGFloat = 40.0
