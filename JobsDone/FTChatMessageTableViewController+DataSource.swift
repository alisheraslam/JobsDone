...
extension FTChatMessageTableViewController{
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.didChangeStatusBar(_:)), name: UIApplication.didChangeStatusBarOrientationNotification, object: nil)
    ...
    func scrollToBottom(_ animated: Bool) {
        if self.messageArray.count > 0 {        
            ...
            self.messageTableView.scrollToRow(at: IndexPath(row: lastSectionMessageCount, section: lastSection), at: UITableView.ScrollPosition.top, animated: animated)
        }
    }
...
//        self.view.endEditing(true)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = FTChatMessageCell(style: UITableViewCell.CellStyle.default, reuseIdentifier: FTDefaultMessageCellReuseIndentifier, theMessage: message, for: indexPath, lastIndex: messageArray[indexPath.section].count - 1)
        return cell
    }
